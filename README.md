...
基于 [linux.do](https://linux.do/) 社区讨论的 Claude Code 最佳实践，Auto CLI v0.10.0 引入了以下能力：
...
1. **探索-规划-编码工作流**：先探索再规划最后编码，减少返工
2. **上下文感知工作流**：自动注入项目上下文，提升 AI 编码效率
