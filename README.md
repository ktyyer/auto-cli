...
**Q: 如何贡献新的 Skill？**
在 `skills/community/` 下创建 Skill 文件（遵循 Agent Skills 标准 + `tags` 扩展），跑 `node scripts/validate-references.js`，提 PR 到 `dev` 分支。详见 `skills/community/README.md`。
