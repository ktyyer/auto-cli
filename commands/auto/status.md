...
| runs     | OK / MISSING / PARTIAL / ABORTED | runs={n}, latest={runId}, latestState={state}   |
| insights | OK / PARTIAL                     | traps/patterns/decisions/prompts/agent-feedback |
| feedback | OK / PARTIAL                     | agents.json / skills.json                       |
...
```json
{
  ...
  "auto": {
    "cache": { "status": "OK", "files": ["capability-snapshot.json", "pattern-cards.json"] },
    "runs": {
      "status": "OK",
      "count": 0,
      "latestRunId": null,
